                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-menzil-green text-black text-xs font-semibold rounded-lg py-2.5 disabled:opacity-50"
                    >
                      Kaydet
                    </button>
                  </div>
              ...
              <div key={cat.id} className="bg-surface rounded-2xl overflow-hidden">
                  ...
                  {cat.image ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="1.6" className="text-text-muted/50">
                ...
                <div className="p-2.5">
                  ...
                  <div className="flex items-center gap-2.5 mt-2">
                    <button type="button" onClick={() => startEditing(cat)}
                      className="text-text-muted hover:text-foreground" aria-label="Kategoriyi düzenle">
                    ...
                    <button type="button" onClick={() => deleteCategory(cat.id)}
                      className="text-text-muted hover:text-rose" aria-label="Kategoriyi sil">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
